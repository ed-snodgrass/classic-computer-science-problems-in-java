...
public class TravelingSalespersonProblem {
    ...
    public TravelingSalespersonProblem(Map<String, Map<String, Integer>> distances) {
...
//        assert shortestPath != null;
    ...
    public static void main(String[] args) {
        ...
        TravelingSalespersonProblem travelingSalespersonProblem = new TravelingSalespersonProblem(vtDistances);
        String[] shortestPath = travelingSalespersonProblem.findShortestPath();
        int distance = travelingSalespersonProblem.pathDistance(shortestPath);
