...
public class GeneticAlgorithm <C extends Chromosome<C>> {
    ...
    private List<C> pickTournament(int numParticipants, int numPicks) {
        ...
        //Find the numPicks hightes fitnesses in the tournament
    ...
    private void reproduceAndReplace() {
        ...
        //keep going until we've filled the new gernation
    ...
    public C run(int maxGenerations, double threshold) {
        ...
        for (int generation = 0; generation < maxGenerations; generation++) {
            ...
            System.out.println("Generation " + generation +
                    " Best " + best.fitness() +
                    " Avg " + population.stream().mapToDouble(C::fitness).average().orElse(0.));
            reproduceAndReplace();
            mutate();
